...
`codex` 是用 Cheng 重写 `codex-rs` 的第一条可日常使用主线。
...
这里不再复制第二份 `codex/std` 源码，也不再靠 symlink 假共享。
...
artifacts/backend_driver/cheng system-link-exec \
  ...
  --in:/Users/lbcheng/cheng-lang/codex/src/cli/main.cheng \
  --emit:exe \
...
- `codex/src/exec/main.cheng`
- `codex/src/tui/main.cheng`
