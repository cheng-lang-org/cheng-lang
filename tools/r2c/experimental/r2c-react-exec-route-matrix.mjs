...
function parseArgs(argv) {
  ...
  for (let i = 2; i < argv.length; i += 1) {
    ...
    if (arg === '--tsx-ast') out.tsxAstPath = String(argv[++i] || '');
      ...
      console.log('Usage: r2c-react-exec-route-matrix.mjs (--route-catalog <file> | --tsx-ast <file>) --exec-snapshot <file> --truth-routes-file <file> [--codegen-manifest <file>] [--truth-trace <file>] [--out <file>] [--summary-out <file>]');
      process.exit(0);
    }
  }
