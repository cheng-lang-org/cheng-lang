...
import { resolvePrimaryRouteSurface } from './r2c-react-route-matrix-shared.mjs';
import {
...
const UNKNOWN_STATIC_VALUE = Symbol('r2c_react_unknown_static_value');
const STATIC_NO_RETURN = Symbol('r2c_react_static_no_return');
const JSX_RESOLUTION_CONTINUE = Symbol('r2c_react_jsx_resolution_continue');
const JSX_RESOLUTION_NONE = Symbol('r2c_react_jsx_resolution_none');
...
function parseArgs(argv) {
  ...
  for (let i = 2; i < argv.length; i += 1) {
    ...
    if (arg === '--repo') out.repo = String(argv[++i] || '');
      ...
      console.log('Usage: r2c-react-native-gui-bundle.mjs --repo <path> [--out-dir <dir>] [--out <file>] [--summary-out <file>] [--codegen-manifest <file>] [--exec-snapshot <file>] [--host-contract <file>] [--asset-manifest <file>] [--tailwind-manifest <file>] [--route-catalog <file>] [--tsx-ast <file>] [--route-state <id>]');
      process.exit(0);
    }
  }
  if (!out.repo) {
