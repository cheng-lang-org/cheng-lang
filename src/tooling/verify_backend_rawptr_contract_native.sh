...
TOOL_BIN="${TOOLING_SELF_BIN:-$ROOT_DIR/artifacts/tooling_cmd/cheng_tooling.realbin}"
...
case "$TOOL_BIN" in
  */artifacts/tooling_cmd/cheng_tooling|*/artifacts/tooling_cmd/cheng_tooling.bin)
    REALBIN_CANDIDATE="${TOOL_BIN%/*}/cheng_tooling.realbin"
    if [ -f "$REALBIN_CANDIDATE" ]; then
