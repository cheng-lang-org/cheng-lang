...
static void usage(void) {
  fprintf(stderr,
          ...
          "                 artifacts/tooling_cmd/cheng_tooling verify_backend_selfhost_bootstrap_self_obj\n"
          "\n"
          "  fullchain-cold env CLEAN_CHENG_LOCAL=0 FULLCHAIN_REUSE=0\n"
          "                 FULLCHAIN_TOOL_JOBS=3\n"
          "                 artifacts/tooling_cmd/cheng_tooling verify_fullchain_bootstrap\n"
          "\n"
          "  closure-cold   env CLEAN_CHENG_LOCAL=0 BACKEND_PROD_SELFHOST_REUSE=0\n"
          "                 FULLCHAIN_REUSE=0 FULLCHAIN_TOOL_JOBS=3\n"
          "                 artifacts/tooling_cmd/cheng_tooling backend_prod_closure --no-publish\n"
          "\n"
          "Notes:\n"
