...
Notes:
  ...
  - Output stage2 is produced at: artifacts/backend_selfhost_self_obj/backend_mvp_driver.stage2
...
Examples:
  ...
  sh src/tooling/backend_seed_pure.sh --seed:/path/to/backend_mvp_driver.stage2
EOF
}
...
CHENG_SELF_OBJ_BOOTSTRAP_STAGE0="$seed_copy" \
