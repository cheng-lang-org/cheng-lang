...
storage_root="${CHENG_IO_ROOT:-build/cheng_storage}"
mode="${CHENG_PKG_MODE:-${CHENG_IO_MODE:-local}}"
listen_addr="${CHENG_PKG_LISTEN:-${CHENG_IO_LISTEN:-}}"
peer_env="${CHENG_PKG_PEERS:-${CHENG_IO_PEERS:-}}"
peer_args=""
source_listen_addr="${CHENG_PKG_SOURCE_LISTEN:-}"
source_peer_env="${CHENG_PKG_SOURCE_PEERS:-}"
source_peer_args=""
out=""
print_roots=""
