...
__attribute__((weak)) void *get_stdin(void);
__attribute__((weak)) void *get_stdout(void);
...
__attribute__((weak)) void driver_c_dump_prog_stack_to_stderr_bridge(void);

static void driver_c_die(const char *message) {
  fputs(message != NULL ? message : "driver_c fatal", stderr);
  fputc('\n', stderr);
  driver_c_dump_prog_stack_to_stderr_bridge();
...
try_builtin_symbols:
  ...
  if (driver_c_prog_text_eq(symbol, "close") ||
      driver_c_prog_text_eq(symbol, "libc_close")) {
  ...
  if (driver_c_prog_text_eq(symbol, "socket") ||
      driver_c_prog_text_eq(symbol, "libc_socket")) {
  ...
  if (driver_c_prog_text_eq(symbol, "bind") ||
      driver_c_prog_text_eq(symbol, "libc_bind")) {
  ...
  if (driver_c_prog_text_eq(symbol, "fcntl") ||
      driver_c_prog_text_eq(symbol, "libc_fcntl")) {
  ...
  if (driver_c_prog_text_eq(symbol, "setsockopt") ||
      driver_c_prog_text_eq(symbol, "libc_setsockopt")) {
  ...
  if (driver_c_prog_text_eq(symbol, "sendto") ||
      driver_c_prog_text_eq(symbol, "libc_sendto")) {
  ...
  if (driver_c_prog_text_eq(symbol, "recvfrom") ||
      driver_c_prog_text_eq(symbol, "libc_recvfrom")) {
    DriverCProgValue *addr_len_slot = driver_c_prog_slot_from_refish(args[5]);
    socklen_t addr_len = 0;
    socklen_t *addr_len_ptr = NULL;
    if (addr_len_slot != NULL) {
      addr_len = (socklen_t)driver_c_prog_value_to_i32(*addr_len_slot);
      addr_len_ptr = &addr_len;
    } else {
      addr_len_ptr = (socklen_t *)driver_c_prog_value_to_void_ptr(args[5]);
    }
    if (addr_len_ptr != NULL && addr_len_slot == NULL) {
      addr_len = *addr_len_ptr;
    }
    if (addr_len_ptr != NULL) {
      *addr_len_ptr = addr_len;
    ...
    *out = driver_c_prog_value_i32((int32_t)recvfrom(driver_c_prog_value_to_i32(args[0]),
                                                     ...
                                                     addr_len_ptr != NULL ? &addr_len : NULL));
    if (addr_len_slot != NULL) {
      driver_c_prog_assign_slot(addr_len_slot, driver_c_prog_value_i32((int32_t)addr_len));
    } else if (addr_len_ptr != NULL) {
      *addr_len_ptr = addr_len;
    }
    return 1;
  }
  if (driver_c_prog_text_eq(symbol, "getsockname") ||
      driver_c_prog_text_eq(symbol, "libc_getsockname")) {
    DriverCProgValue *addr_len_slot = driver_c_prog_slot_from_refish(args[2]);
    socklen_t addr_len = 0;
    socklen_t *addr_len_ptr = NULL;
    if (addr_len_slot != NULL) {
      addr_len = (socklen_t)driver_c_prog_value_to_i32(*addr_len_slot);
      ...
      addr_len_ptr = (socklen_t *)driver_c_prog_value_to_void_ptr(args[2]);
    }
    if (addr_len_ptr != NULL && addr_len_slot == NULL) {
      addr_len = *addr_len_ptr;
    }
    *out = driver_c_prog_value_i32((int32_t)getsockname(driver_c_prog_value_to_i32(args[0]),
                                                        (struct sockaddr *)driver_c_prog_value_to_void_ptr(args[1]),
                                                        addr_len_ptr != NULL ? &addr_len : NULL));
    if (addr_len_slot != NULL) {
      driver_c_prog_assign_slot(addr_len_slot, driver_c_prog_value_i32((int32_t)addr_len));
    } else if (addr_len_ptr != NULL) {
  ...
  if (driver_c_prog_text_eq(symbol, "cheng_v3_udp_recvfrom_addr_bridge")) {
    DriverCProgValue *addr_len_slot = driver_c_prog_slot_from_refish(args[6]);
    DriverCProgValue *err_slot = driver_c_prog_slot_from_refish(args[7]);
    int32_t out_addr_len = 0;
    int32_t out_err = 0;
    int32_t *out_addr_len_ptr = NULL;
    int32_t *out_err_ptr = NULL;
    if (addr_len_slot != NULL) {
      out_addr_len = driver_c_prog_value_to_i32(*addr_len_slot);
      out_addr_len_ptr = &out_addr_len;
    } else {
      out_addr_len_ptr = (int32_t *)driver_c_prog_value_to_void_ptr(args[6]);
      if (out_addr_len_ptr != NULL) {
        out_addr_len = *out_addr_len_ptr;
      }
    }
    if (err_slot != NULL) {
      out_err = driver_c_prog_value_to_i32(*err_slot);
      out_err_ptr = &out_err;
    } else {
      out_err_ptr = (int32_t *)driver_c_prog_value_to_void_ptr(args[7]);
      if (out_err_ptr != NULL) {
        out_err = *out_err_ptr;
      }
    }
    *out = driver_c_prog_value_i32(cheng_v3_udp_recvfrom_addr_bridge(driver_c_prog_value_to_i32(args[0]),
                                                                     driver_c_prog_value_to_void_ptr(args[1]),
                                                                     driver_c_prog_value_to_i32(args[2]),
                                                                     driver_c_prog_value_to_i32(args[3]),
                                                                     driver_c_prog_value_to_void_ptr(args[4]),
                                                                     driver_c_prog_value_to_i32(args[5]),
                                                                     out_addr_len_ptr,
                                                                     out_err_ptr));
    if (addr_len_slot != NULL) {
      driver_c_prog_assign_slot(addr_len_slot, driver_c_prog_value_i32(out_addr_len));
    } else if (out_addr_len_ptr != NULL) {
      *out_addr_len_ptr = out_addr_len;
    }
    if (err_slot != NULL) {
      driver_c_prog_assign_slot(err_slot, driver_c_prog_value_i32(out_err));
    } else if (out_err_ptr != NULL) {
      *out_err_ptr = out_err;
    }
    return 1;
  }
  if (driver_c_prog_text_eq(symbol, "inet_pton") ||
      driver_c_prog_text_eq(symbol, "libc_inet_pton")) {
  ...
  if (driver_c_prog_text_eq(symbol, "inet_ntop") ||
      driver_c_prog_text_eq(symbol, "libc_inet_ntop")) {
