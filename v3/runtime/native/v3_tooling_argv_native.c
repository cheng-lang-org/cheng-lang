...
extern int32_t cheng_v3_tooling_argv_entry(int32_t argc, const char **argv);
...
char *cheng_v3_exec_program_capture_bridge(const char *programName,
                                           void *argvSeqPtr,
                                           const char *workingDir,
                                           int64_t *exitCode) {
  char capture_path[] = "/tmp/cheng_v3_exec_capture.XXXXXX";
  char **argv = NULL;
  int capture_fd = -1;
  pid_t pid = -1;
  int wait_status = 0;
...
int main(int argc, char **argv) {
  ...
  return cheng_v3_tooling_argv_entry((int32_t)argc, (const char **)argv);
}
