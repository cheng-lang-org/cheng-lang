...
#    define CHENG_NIL nullptr
#  else
#    define CHENG_NIL 0
#  endif
#else
#  include <stdbool.h>
#  define CHENG_NIL NULL
#endif
...
#ifndef CHENG_TYPE_ALIASES
#define CHENG_TYPE_ALIASES 1
typedef NI8 int8;
typedef NI16 int16;
typedef NI32 int32;
typedef NI64 int64;
...
typedef NI64 NI;
typedef NU64 NU;
#  elif CHENG_INTBITS == 32
typedef NI32 NI;
typedef NU32 NU;
#  elif CHENG_INTBITS == 16
typedef NI16 NI;
typedef NU16 NU;
#  elif CHENG_INTBITS == 8
typedef NI8 NI;
typedef NU8 NU;
#  else
...
#define CHENG_TRUE true
#define CHENG_FALSE false
...
#ifndef CHENG_RESULT_HELPERS
#define CHENG_RESULT_HELPERS 1
#  ifdef IsOk
#    undef IsOk
#  endif
#  define IsOk(r) ((r).ok)
...
#ifdef  __cplusplus
#  define CHENG_EXTERNC extern "C"
#else
#  define CHENG_EXTERNC
#endif
...
#    define N_LIB_EXPORT  CHENG_EXTERNC __declspec(dllexport) __attribute__((used))
#    define N_LIB_EXPORT_VAR  __declspec(dllexport) __attribute__((used))
#  else
#    define N_LIB_EXPORT  CHENG_EXTERNC __declspec(dllexport)
...
#  endif
#  ifdef __EMSCRIPTEN__
#    define N_LIB_EXPORT CHENG_EXTERNC __attribute__((visibility("default"), used))
#    define N_LIB_EXPORT_VAR  __attribute__((visibility("default"), used))
#  else
#    define N_LIB_EXPORT CHENG_EXTERNC __attribute__((visibility("default")))
...
#if defined(_MSC_VER)
#  define CHENG_ALIGN(x)  __declspec(align(x))
#  define CHENG_ALIGNOF(x) __alignof(x)
#else
#  define CHENG_ALIGN(x)  __attribute__((aligned(x)))
#  define CHENG_ALIGNOF(x) __alignof__(x)
#endif
