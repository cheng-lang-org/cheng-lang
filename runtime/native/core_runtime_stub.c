...
#include "../../src/core/runtime/runtime_abi.h"
...
int32_t core_runtime_stub_trace(void) {
  static const char msg[] = "core runtime trace\n";
...
static int cheng_core_bio_hex_encode_utf8(const char* src, char* out, size_t out_cap) {
...
__attribute__((weak)) ChengStrBridge cheng_mobile_biometric_fingerprint_authorize_bridge_native(ChengStrBridge request_wire) {
  ...
  error_hex[0] = '\0';
  (void)cheng_core_bio_hex_encode_utf8("biometric: mobile host bridge missing", error_hex, sizeof(error_hex));
